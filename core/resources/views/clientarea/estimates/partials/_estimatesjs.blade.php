...
function cloneRow(in_tbl_name)
{
    ...
    var strHtml3 = '<div class="form-group">{!! Form::textarea("item_description",null, ["class" => "form-control item_description input-sm", "id"=>"item_description" ,"required", "rows"=>"1" ]) !!}</div>';
    ...
    var strHtml7 = '<span class="currencySymbol"></span><span class="itemTotal">0.00</span> ';
